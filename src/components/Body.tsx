    ...
    return (
        <main className="grid grid-cols-1 gap-20 w-full md:gap-50">
            <section className="flex flex-col gap-5 items-center md:items-start w-full md:relative md:max-w-200 md:place-self-center xl:min-w-350">
                ...
                <div className="flex flex-col md:text-left md:gap-5 md:w-98 md:absolute md:top-30 md:right-0 md:p-10 bg-white xl:top-50 xl:w-190 xl:p-20">
                    <h2 className="text-3xl tracking-wider font-light capitalize md:text-4xl xl:text-6xl xl:tracking-widest">The leader in interactive VR</h2>
                    <p className="text-gray-500 font-medium md:text-xs xl:text-lg">
            ...
            <section className="grid grid-cols-1 gap-10 md:min-w-200 md:place-self-center xl:min-w-350">
                ...
                <div className="grid grid-rows-8 gap-5 w-full md:grid-rows-2 md:grid-cols-4">
                {
                    ...
                    return (
                        <div>
                            ...
                            <section key={index} 
                                     className={`[ text-white text-xl text-bottom font-light ] [ transition delay-150 duration-300 ease-in-out hover:scale-102 hover:grayscale active:grayscale active:scale-105 hover:cursor-pointer ] [ ${bgImageDesktop[count]} bg-center bg-cover bg-no-repeat ] [ p-5 ] [ min-h-80 xl:min-h-150 ] [ relative ] max-md:hidden max-md:aria-hidden`}>
                                <h3 className="absolute bottom-10 xl:text-3xl select-none">{item}</h3>
                            </section>
                        </div>   
                    )
                    })
