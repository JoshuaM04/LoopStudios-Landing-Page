                ...
                <div className="grid grid-rows-8 gap-5 w-full md:grid-rows-2 md:grid-cols-4">
                {
                    ...
                    return (
                        <div>
                            ...
                            <section key={index} 
                                     className={`[ text-white text-xl text-bottom font-light ] [ transition delay-150 duration-300 ease-in-out hover:scale-102 active:scale-105 hover:cursor-pointer ] [ ${bgImageDesktop[count]} bg-center bg-cover bg-no-repeat ] [ p-5 ] [ min-h-80 2xl:min-h-150 ] [ relative ] max-md:hidden max-md:aria-hidden`}>
