            ...
            <section className="flex justify-center gap-5">
                ...
                <button className="hover:scale-120 active:scale-120 transition delay-50 ease-in-out" aria-label="Instagram link">
                    <a href="https://www.instagram.com/" target="_blank">
                        <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" className="fill-white hover:bg-gradient-to-r active:bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-md">
